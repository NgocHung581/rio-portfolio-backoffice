...
return [
    ...
    */
    ...
    'max' => [
        ...
        'file' => 'Tệp không được lớn hơn :max KB.',
        'numeric' => 'Trường này không được lớn hơn :max.',
        'string' => 'Trường này không được dài hơn :max ký tự.',
    ],
    'mimes' => 'Tệp không hợp lệ. Chỉ chấp nhận các định dạng: :values.',
    'mimetypes' => 'Tệp không hợp lệ. Chỉ chấp nhận các định dạng: :values.',
    'min' => [
