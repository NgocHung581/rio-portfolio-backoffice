...
namespace App\Http\Requests\AlbumMedia;
...
class CreateAlbumMediaRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        match ($this->media_type) {
            MediaType::Image->value => $mediaCountLimitPerUpload = AlbumMediaSetting::IMAGES_COUNT_LIMIT_PER_UPLOAD,
            MediaType::Video->value => $mediaCountLimitPerUpload = AlbumMediaSetting::VIDEOS_COUNT_LIMIT_PER_UPLOAD,
        };
        ...
        return [
            ...
            'media.*.column_span' => ['required', 'integer', Rule::in(AlbumMediaColumnSpan::cases())],
    ...
    public function attributes(): array
    {
        ...
        match ($this->media_type) {
            MediaType::Image->value => $mediaFileLabel = __('image'),
            MediaType::Video->value => $mediaFileLabel = __('video'),
        };
